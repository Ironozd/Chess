...
\DoxyCodeLine{\Hypertarget{_physical_device_8cpp_source_l00010}00010\ \textcolor{keyword}{namespace\ }Renderer}
...
\DoxyCodeLine{\Hypertarget{_physical_device_8cpp_source_l00029}00029\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classstd_1_1vector}{std::vector<VkPhysicalDevice>}}\ devices(deviceCount);}
...
\DoxyCodeLine{\Hypertarget{_physical_device_8cpp_source_l00061}00061\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classstd_1_1vector}{std::vector<VkQueueFamilyProperties>}}\ queueFamilies(queueFamilyCount);}
